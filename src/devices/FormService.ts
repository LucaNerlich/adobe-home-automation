...
import {createProvider} from './DeviceService'
import {getProviderContainer} from '../domUtils'

const TOPIC_FORM_NAME = 'topic'
const STRATEGIES_FORM_NAME = 'strategies'
...
function getTopicValue(topicInput: string) {
